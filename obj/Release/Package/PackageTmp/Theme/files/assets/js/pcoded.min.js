...
$.fn.pcodedmenu = function(settings) {
    ...
    var defaults = {
        ...
        HeaderBackground: 'theme6', // Value should be theme6/theme2/theme3/theme4/theme5/theme6/theme7/theme8/theme9
        LHeaderBackground: 'theme6', // Value should be theme6/theme2/theme3/theme4/theme5/theme6/theme7/theme8/theme9
        NavbarBackground: 'theme6', // Value should be theme6/theme2/theme3/theme4/theme5/theme6/theme7/theme8/theme9
        ActiveItemBackground: 'theme0', // Value should be theme6/theme2/theme3/theme4/theme5/theme6/theme7/theme8/theme9
        SubItemBackground: 'theme6', // Value should be theme6/theme2/theme3/theme4/theme5/theme6/theme7/theme8/theme9
        ...
        HandleThemeBackground: function() {
            ...
            function setnavbartheme() {
                ...
                if (ev != undefined && ev != "") {
                    ...
                    $('#' + oid + ' .pcoded-navbar').attr("navbar-theme", "theme6");
                }
            };
            ...
            function setactiveitemtheme() {
                ...
                if (ev != undefined && ev != "") {
                    ...
                    $('#' + oid + ' .pcoded-navbar').attr("active-item-theme", "theme6");
                }
            };
            ...
            function setsubitemtheme() {
                ...
                if (ev != undefined && ev != "") {
                    ...
                    $('#' + oid + ' .pcoded-navbar').attr("sub-item-theme", "theme6");
                }
            };
